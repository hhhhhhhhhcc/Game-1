...
//删除Unit缓存
	...
	[ResponseType(nameof(M2G_GetRoomIndex))]
	[Message(InnerOpcode.G2M_GetRoomIndex)]
	[ProtoContract]
	public partial class G2M_GetRoomIndex: Object, IActorRequest
	{
		[ProtoMember(90)]
		public int RpcId { get; set; }
	...
	[Message(InnerOpcode.M2G_GetRoomIndex)]
	[ProtoContract]
	public partial class M2G_GetRoomIndex: Object, IActorResponse
	{
		[ProtoMember(90)]
		public int RpcId { get; set; }
