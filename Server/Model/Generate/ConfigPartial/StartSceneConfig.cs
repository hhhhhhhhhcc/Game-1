...
namespace ET
{
    public partial class StartSceneConfigCategory
    {
        ...
        public Dictionary<long, StartSceneConfig> UnitCaches = new Dictionary<long, StartSceneConfig>();
        ...
        public StartSceneConfig GetUnitCacheConfig(long serverid)
        {
            return UnitCaches[serverid];
        }
