...
namespace ET
{
	...
	public  class Scroll_Item_serverTest : Entity,IAwake,IDestroy,IUIScrollItem 
	{
		...
		public UnityEngine.UI.Button EI_serverTestButton
     	{
     		get
     		{
     			...
     			if (this.isCacheNode)
     			{
     				if( this.m_EI_serverTestButton == null )
     				{
		    			this.m_EI_serverTestButton = UIFindHelper.FindDeepChild<UnityEngine.UI.Button>(this.uiTransform.gameObject,"EI_serverTest");
     				}
     				return this.m_EI_serverTestButton;
     			}
     			else
     			{
		    		return UIFindHelper.FindDeepChild<UnityEngine.UI.Button>(this.uiTransform.gameObject,"EI_serverTest");
     			}
     		}
     	}
		...
		{
			this.m_EI_serverTestButton = null;
		...
		private UnityEngine.UI.Button m_EI_serverTestButton = null;
